...
def build_transformer(tgt_vocab_size: int, tgt_seq_len: int, d_model: int = 512, N: int = 6, h: int = 8, dropout: float = 0.1, d_ff: int = 2048, encoder_hidden_dim: int = 512) -> Transformer:
    ...
    mlp_encoder = MLPEncoder(input_dim=d_model, hidden_dim=encoder_hidden_dim)

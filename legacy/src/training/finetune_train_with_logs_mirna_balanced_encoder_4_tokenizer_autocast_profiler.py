...
from legacy.src.models import build_transformer
from legacy.src.utils.utils import KMerTokenizer, save_model, visualize_mismatch, clean_sequence
...
PYTHONPATH=rf"/root/Aptamers_Model/Aptamers_Model"
DATA_PATH=rf"/root/Aptamers_Model/Aptamers_Model/data"
OUTPUTS_PATH=rf"/root/Aptamers_Model/Aptamers_Model/outputs"
CHECKPOINTS_PATH=rf"/root/Aptamers_Model/Aptamers_Model/outputs/checkpoints"
MLRUNS_PATH=rf"/root/Aptamers_Model/Aptamers_Model/outputs/mlruns"
CONFIG_PATH=rf"/root/Aptamers_Model/Aptamers_Model/conf"

embeddings_path = rf"/root/Aptamers_Model/Aptamers_Model/data/esm"
...
df_path = rf'/root/Aptamers_Model/Aptamers_Model/data/3_checked_intersections_180t.csv'
...
def train(model: torch.nn.Module, 
          ...
          epochs: int = 5):
    mlflow.set_tracking_uri(rf"file:///root/Aptamers_Model/Aptamers_Model/outputs/mlruns")
...
model.load_state_dict(torch.load(rf"/root/Aptamers_Model/Aptamers_Model/outputs/checkpoints/Transformer_with_mirna_encode_early_stopped.pth"))  # загружаем веса
model.to(device)
